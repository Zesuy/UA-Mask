...
为什么不使用 nfqueue 模式？
- 我们选择“L7 分析处理 + L4 绕过”的策略，目的是“在不泄露 UA 的前提下尽量高效”。nfqueue 在 L4 处理 TCP，若仅截取首包并依靠标记返回，无法完整覆盖 keep-alive 连接中的后续 HTTP 请求，存在 UA 泄露风险。除非为极端性能让位，我们更倾向于完整、可验证的 L7 级安全性。

UA3F 与“IP 绕过/流量卸载”的现状？
- 关于“基于 ipset/nfset 的智能卸载/绕过”：据我们在公开版本与文档中的了解到（截至 2025-11-10），UA3F 尚未提供与本项目等价的“非 HTTP 流量智能卸载”能力。若该情况已变更，以其官方仓库说明为准，也欢迎社区指出与修正。
...
- 上游项目
  ...
  - 许可证：<https://github.com/SunBK201/UA3F/blob/main/LICENSE>
